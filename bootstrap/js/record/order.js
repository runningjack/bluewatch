...
$("#flash").fadeIn(400).html('<img src="img/websedit-ag-bar.gif" align="absmiddle"> <span class="loading">Saving Please wait...</span>');
	
$.ajax({
            type: "POST",
            url: "admin/ajax2/additems",
            data: myData,
			...
			//document.getElementById('physical').reset()
				...
				//document.forms['physical'].interview_id.value = "";
