  ...
  <tr>
    <td align="center" valign="middle" background="modules/content_manager/images/hd.png"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="47%" height="50" align="left" valign="bottom"><span class="errorMsg">
          <?= $_GET['msg']; ?>
          <?= $getMsg; ?>
          </span>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         <td height="71" align="left" valign="middle"><p><a href="?<?= PROJECTNAME; ?>=Control Panel&amp;INC=Content Manager&amp;CMD=Create Web Page"><img src="modules/content_manager/images/page_add.png" border="0" /> Create web page</a></p>
           <div><a href="#" onclick="javascript: if(document.getElementById('search').style.display == 'block'){ document.getElementById('search').style.display = 'none';} else { document.getElementById('search').style.display = 'block'; document.getElementById('search').focus(); }"><img src="modules/content_manager/images/search.png" border="0" /> Search</a></div></td>
       </tr>
     </table><p><p>
     <? include('modules/content_manager/components/treeview.php'); ?>
     </div></td>
     <td width="79%" align="center" valign="top"><br />
       <form id="form1" name="form1" method="post" action="" onsubmit="return verify_checkbox()">
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #F2F2F2">
           <tr>
             <td height="544" align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
               <tr>
                 ...
                 <td width="151" align="left" valign="middle" class="errorMsg">&nbsp;
                   <label>
                     <input type="submit" name="button" id="button" value="Delete All" />
                  </label></td>
                </tr>
               <?   content_man_class::get_all_sub_webpages(); // method that displays all web page ?>
             </table></td>
           </tr>
         </table>
     </form></td>
