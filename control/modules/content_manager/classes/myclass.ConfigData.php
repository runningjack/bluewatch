...
private static $dbname = "fcegusau_db";          // The Name of the Database
private static $dbuser = "fcegusau_admin";        // The username to connect to the database
private static $dbpass = "h7Bq@M21F*Og";   	// The Password to connect to the database
private $mysqli_conn;
