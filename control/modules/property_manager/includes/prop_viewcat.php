...
<div>
<h2>VIEW EXISITING CATEGORIES</h2>
...
if( (isset($_GET['STA'])))
{
	...
	{
	 	case "confirm":
		$returnstring = " Category Successfully Updated";
		break;
...
{	
	 ...
	 while ($row = $result->fetch_assoc())
	 {
		...
		echo "<td class='prop_cols'><a href='.?BQ=Control Panel&INC=Property&CMD=Edit_Cat&ACT=Edit&PID=$row[propcat_id]&CAS=0'><img src='modules/property_manager/images/edit.png' /></a></td>";
		echo "<td class='prop_cols'><a href='.?BQ=Control Panel&INC=Property&CMD=Del_Cat&ACT=Delete&PID=$row[propcat_id]&CAS=0'><img src='modules/property_manager/images/no.gif' /></a></td></tr>";
		$counter++;
	 }
