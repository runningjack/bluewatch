...
// IF NO ERROR FOUND TRY INSERTION TO DATABASE
	...
	{	
		...
		$data = array("propcat_name" => $catigname,
					  "propcat_belongs" => "prop_leasetype"
					  );
		...
		{	
			...
			header("Location: .?BQ=Control Panel&INC=Property&CMD=View_Lease_Type&STA=confirm");
		}else
		{ 
...
<div>
<h2>ADD A NEW LEASING CATEGORY</h2>
...
<fieldset>
<legend align="right">Create New Leasing Type</legend>
<form name="" method="post" action="">
<table width="830">
<tr>
    <td width="162"><label>Leasing Category Name:</label></td>
    <td width="240"><input type="text" name="catig" size="40" /></td>
    <td width="412"><span class="prop_formerror"><?php echo $formarr['catig']; ?></span></td>
</tr>

<tr>
<td></td>
<td><input type="submit" name="submit" value="Create Leasing Type"/></td>
<td></td>
</tr>
</table>
</form>
