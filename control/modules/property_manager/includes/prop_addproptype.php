...
// IF NO ERROR FOUND TRY INSERTION TO DATABASE
	...
	{	
		...
		{	
			...
			header("Location: .?BQ=Control Panel&INC=Property&CMD=View_Prop_Type&STA=confirm");
		}else
		{ 
...
<fieldset>
<legend align="right">Create Property Category</legend>
<form name="" method="post" action="">
<table width="830">
<tr>
    <td width="172"><label>Property Category Name:</label></td>
    <td width="254"><input type="text" name="catig" size="40" /></td>
    <td width="388"><span class="prop_formerror"><?php echo $formarr['catig']; ?></span></td>
</tr>

<tr>
<td></td>
<td><input type="submit" name="submit" value="Create Property Category"/></td>
<td></td>
</tr>
</table>
</form>
