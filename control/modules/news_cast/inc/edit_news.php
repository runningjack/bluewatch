...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" valign="middle" background="modules/news_cast/images/hd.png">
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td height="50" align="left" valign="bottom"><img src="modules/news_cast/images/newsd.png" width="32" height="32" /> <strong style="font-size:16px">Update  News</strong></td>
...
<table width="98%" border="0" align="center" cellpadding="10" cellspacing="0" style="border:1px solid #EEE">
    ...
    <tr>
        ...
        <td width="83%" align="left" valign="middle">
            <input name="news_name" type="text" class="txtbox" id="news_name" size="50" value="<?= $getdetails['name'];?>" />      
            &nbsp;&nbsp;
            <input type="checkbox" name="validate" id="validate"  onclick="validate_name()" />
            <span style="font-size:10px; color:#999">(Validate news name if there is a change. Make sure you don't use digits or special characters)</span>
        </td>
    </tr>
    <tr>
        <td align="left" valign="middle"><strong>Title</strong></td>
        <td align="left" valign="middle"><input name="news_title" type="text" class="txtbox" id="news_title" size="50" value="<?= $getdetails['title'];?>"/></td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">
            ...
            <span style="font-size:10px; color:#999">Check this box if you want to change the thumbnail</span>
            <br><br>
    ...
    <tr>
        ...
        <td align="left" valign="middle">
            <label>
                <select name="news_cat" id="news_cat" onchange="showparent(this.options[this.selectedIndex].value)" <? if($getdetails['category'] == "Parent"){ echo "disabled";}?>>
                    <option value="Parent">Parent</option>
                    <option value="Child">Child</option>
                    <option value="<?= $getdetails['category']; ?>" selected="selected"><?= $getdetails['category']; ?></option>
                </select>
            </label>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">
            ...
            if($getdetails['category'] == "Child"){ news_class::get_parent_name($getdetails['idx']); }
            ?>
            </select> 
        </td>
    </tr>
    <tr>
        ...
        <!--<td align="left" valign="middle"><textarea name="content" id="content"><?= stripslashes($getdetails['content']); ?></textarea></td>-->
        <td align="left" valign="middle">
        <?php
        //// Include the CKEditor class.
        include_once "modules/news_cast/ckeditor/ckeditor.php";
        //// The initial value to be displayed in the editor.
        $initialValue = stripslashes($getdetails['content']);
    ...
    <tr>
        ...
        <td align="left" valign="middle">
            <label>
                <input name="publish" type="radio" id="radio" value="Yes" <? if($getdetails['pub'] == "Yes"){ echo "Checked"; }?>/>Yes
                <input type="radio" name="publish" id="radio2" value="No" <? if($getdetails['pub'] == "No"){ echo "Checked"; }?>/>No
            </label>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">
            <input type="submit" name="submit" id="submit" value="Update News" class="submitbtn"/>
...
var p = document.getElementById("news_cat").value;
if(p == "Child"){ 
