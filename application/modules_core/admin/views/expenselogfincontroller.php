...
<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">							
							<h3>Employee Expense Request Log (Financial Controller)</h3><br>
            ...
            <?php
								...
								<table class="table table-bordered" id="datatable2" >
                                    ...
                                    <td colspan="7"><strong>Project Details</strong></td>
...
<td>
  ...
  // var_dump($_SESSION['login_detal']->group_id == 5);exit;
   ...
   if ($data->account_controller_status != 1 && $_SESSION['login_detal']->group_id == 7 ) {
            ?>
   <a 
      href="<?php echo base_url('admin/projectexpense/projectfinupdate/'.$data->proj_exp_id); ?>" > <button class="btn btn-warning" type="button">Approve / Assign Director</button></a>
  ...
  // var_dump($_SESSION['login_detal']->group_id == 5);exit;
   ...
   if ($data->director_status == 1 && $_SESSION['login_detal']->group_id == 7 ) {
            ?>
   <a 
      href="<?php echo base_url('admin/projectexpense/projectfinupdate/'.$data->proj_exp_id); ?>" > <button class="btn btn-success" type="button">Paid</button></a>
