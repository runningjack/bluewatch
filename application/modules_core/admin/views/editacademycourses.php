              ...
              echo form_open('admin/academycourses/edit/'.$id,$attributes); //var_dump($courseoption_details);die;?>
								<table class="table table-bordered" >
                                                                    <tr><td><strong>Faculty Name:</strong></td>
                                                                        <td> <?php echo form_dropdown('faculty_id', $progelement,$academycourses_details['faculty_id'],'required="" class="form-control" id="faculty_id"'); ?></td></tr>
                                                                    <tr><td><strong>Department Name:</strong></td><td>
                                                                            <span id="loaddepartment"></span>
                                                                  <?php echo form_dropdown('department_id', $deptelement,$academycourses_details['department_id'],'required="" class="form-control" id="department_id"'); ?>
                                                                        
                                                                        </td></tr>
                                                                    
                                                                     <tr><td><strong>Level:</strong></td><td>
                                                                            <span id="loaddepartment"></span>
                                                <?php echo form_dropdown('level_id', $levelelement,$academycourses_details['level_id'],'required="" class="form-control" id="level_id"'); ?></td></tr>
                                                                     
                                       <tr><td><strong>Semester :</strong></td><td>
                                                                            <span id="loaddepartment"></span>
                                                <?php echo form_dropdown('semester_id', $semesterelement,$academycourses_details['semester'],'required="" class="form-control" id="semester_id"'); ?></td></tr>                              
