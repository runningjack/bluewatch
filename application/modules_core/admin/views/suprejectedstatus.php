...
<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">							
							<h3>Supervisor Rejected Transaction</h3>
        <a href="<?php echo base_url("admin/report/suprejectedtoexcel/");?>" target="_blank">[Export to Excel]</a>
        <a href="<?php echo base_url("admin/report/printrejected/");?>" target="_blank">[Print]</a>      
...
<!--<a href="<?php echo base_url("admin/report/delete/".$data->transaction_no);?>"><button class="btn btn-danger" type="button">Delete Unit</button>-->
    <?php }?>
</td>
