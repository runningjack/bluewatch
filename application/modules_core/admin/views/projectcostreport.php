        ...
        <div class="block-flat">
            <div class="header">
                ...
                <h3>PROJECT COST [<a onclick="print();">Print</a>]
                    ...
                    <a href="<?php echo base_url('admin/projectexpense/projectcostreportexcel') ?>">
                        Export to excel
                    </a>
                </h3>
                <?php }?>
                ...
                <div class="form-group">
                    ...
                    <div class=" alert alert-success alert-white rounded">
                       ...
                       // if($group_id==4){
                            ...
                            ?>
                       <?php echo form_open('admin/projectexpense/projectcostreport', $attributes); ?>
...
>
                                          ...
                                          <td>
                                          <?php 
                                          if($project_hourly_logged[$ap->id]['amount']>0)
                                           {
