...
<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">							
							<h3>Employee Expense Request Log (Director)</h3>
...
<td>
  ...
  // var_dump($_SESSION['login_detal']->group_id == 5);exit;
   //&& $_SESSION['login_detal']->group_id == 2
   if ($data->account_controller_status == 1  && $data->director_status != 1 ) {
            ?>
   <a 
      href="<?php echo base_url('admin/projectexpense/dirupdate/'.$data->proj_exp_id); ?>" > <button class="btn btn-warning" type="button">Approve / Assign Director</button></a>
