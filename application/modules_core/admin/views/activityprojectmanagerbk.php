...
<td>
  ...
  // var_dump($_SESSION["login_detal"]->group_id);exit;
   ...
   if ($_SESSION["login_detal"]->group_id == 5 && $data->project_manager_status != 1 && $data->team_lead_status == 1) {
            ?>
   <a 
      href="<?php echo base_url('admin/projectlogs/reviewproject/'.$data->activity_id); ?>" > <button class="btn btn-info" type="button">Review Activity</button></a>
