...
//var_dump($modulesarray);
                ...
                ?>
          <div class="content">
              <?php $attributes = array('id' => 'departmentForm');
              echo form_open('admin/settings/addDepartment', $attributes); ?>
             <div class="form-horizontal"  parsley-validate novalidate>
                 <div class="form-group">
                     <fieldset> <legend> Department </legend>
                        ...
                        <td><label >
                                <strong>Department Name :</strong></label></td><td><?php echo form_input($form_username); ?> </td>
                    ...
                    <tr>
                        ...
                        <td><label >
                                </label></td><td colspan="4"><input type='submit' name='submit' value='Add Department' class="btn btn-success"></td>
                    </tr>
