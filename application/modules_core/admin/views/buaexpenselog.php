...
<td>
   <?php if ($data->hod_status != 1) {
            ?>
   <a 
      href="<?php echo base_url('admin/bauexpense/editclaimexpense/'.$data->bau_exp_id); ?>" > <button class="btn btn-info" type="button">Update Activity</button></a> &nbsp;&nbsp;
      <a 
      href="javascript:void(0);" onclick="deleteBau(<?=$data->bau_exp_id?>)" > <button class="btn btn-danger" type="button">Delete Activity</button></a>
...
<script type="text/javascript">
  function deleteBau(bauid) {
    if (confirm("Are you sure you want to delete?")) {
    var url = "<?=base_url('admin/bauexpense/deleteclaimexpense');?>"+"/"+bauid;
