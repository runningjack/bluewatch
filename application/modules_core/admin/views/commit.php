				...
				<div class="col-md-8">
                 ...
                 <div class="form-group">
								...
								<strong>Success!</strong> <?php echo $sucess_message;?>!
                                                                <br/>
                                <a href="<?php echo base_url("admin/report/transactiondetails//".$trans_id);?>">Print Receipt  </a>							 </div>
                                                           <?php }?>
...
<table>
                     <tr><td><strong>Transaction Id :</strong></td><td><?php echo form_input($form_transaction_id); ?></td>
                         <td colspan="8">
                             <input   style="float: right;" class="btn btn-primary"  type='submit' name='fetch' value='Fatch Transaction Details'></td>
                         </tr>
                    ...
                    if(isset($trans_details['trans_total_amount'])){ 
                     ...
                     <table>
                       ...
                       <!--  <tr><td>Amount Owning</td><td><?php  echo number_format($trans_details["trans_total_amount"]-$previous_amount,2) ?></td></tr>-->
                         <tr><td>Cashier Payment Status</td><td><?php  echo $trans_details["status"]?></td></tr>
                  ...
                  <!--  <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                     ...
                     <tr><td>Tendered Amount</td><td class="input-group">
                          <span class="input-group-addon">N</span>
                            <input type="text" name="tendered_amount" disabled="" value="<?php echo $trans_details["trans_total_amount"]; ?>"  id="tendered_amount"/>
                            <span class="input-group-addon">.00</span>  </td></tr>
                           
                       <?php
                      
                       $current_id = $current_batch["batch_id"];
                       $todaydate = date("Y-n-j");  
                       $expiringdate = $current_batch["end_date"];
                       $tran_batch_id = $trans_status["batch_id"];
                       if($trans_details["status"]=='Full Payment'){ print'This Transaction has Been Fully Paid for';}else{
                       ?>
                        <tr>
                            <td colspan="2">
                                 <input type="submit"  style=" float: right;" class="btn btn-danger" name="reject" id="reject" value="Reject"/></td> 
                             <td colspan="2">
                                 <input type="submit"  style=" float: right;" class="btn btn-primary" name="commit" id="commit" value="Process"/></td></tr>
                     </table>
