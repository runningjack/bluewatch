...
<div class="row">
    <div class="col-md-12">
        <div class="block-flat">
            <div class="header">
                <h3>DEPARTMENTAL PROFITABILITY [<a onclick="print();">Print</a>]

                    <a href="<?php echo base_url('admin/projectexpense/projectreportprofitabilityExcel') ?>">
                        Export to excel
                    </a>
                </h3>
            ...
            <div class="form-horizontal" parsley-validate novalidate>
                <div class="form-group">
                    ...
                    <div class=" alert alert-success alert-white rounded">
                        ...
                        echo form_open('admin/projectexpense/projectreportprofitability', $attributes); ?>
                                        ...
                                        <table class="table">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <?php echo number_format($recievable[$dept->id][$head->revenue_head],2);
                                                            $row_total =  $row_total+ $recievable[$dept->id][$head->revenue_head];
                                                            $recievable_head_sum_expense[$head->revenue_head][] = $recievable[$dept->id][$head->revenue_head];
                                                            ?>
                                                        </td>
                                                        <td><?php
                                                            //var_dump($expByProjectPersonel[$dept->id]);//exit;
                                                            // if ($head->revenue_head == "BCT-Services") {
                                                            //     $expByDeptRevenueHead[$dept->id][$head->revenue_head] =
                                                            //         $expByDeptRevenueHead[$dept->id][$head->revenue_head] + $expByProjectPersonel[$dept->id];
                                                            // }

                                                            if ($expByDeptRevenueHead[$dept->id][$head->revenue_head]) {
                                                        ...
                                                        <td>
                                                            <?php $revenue = $recievable[$dept->id][$head->revenue_head] - $expByDeptRevenueHead[$dept->id][$head->revenue_head];
                                                    ...
                                                    <td><?php echo number_format($row_total - $expense_sum,2);

                                                        $budget_ground_sum =   $budget_ground_sum  + $budget_sum;
                                                        $expense_ground_sum = $expense_ground_sum + $expense_sum;
                                                        $profit_ground_sum =  $profit_ground_sum + ($row_total - $expense_sum);
                                                        $ground_recieable = $ground_recieable+$row_total;
                                            ...
                                            <tr>
                                                ...
                                                <?php foreach ($getRevenueHead as $rev_head) { ?>
                                                    ...
                                                    <td>
                                                        <?php print number_format(array_sum($recievable_head_sum_expense[$rev_head->revenue_head]), 2); ?>
                                                    </td>
                                                ...
                                                <td><?php echo number_format($ground_recieable, 2); ?></td>
