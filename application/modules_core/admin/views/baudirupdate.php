    ...
    //  var_dump($log_details);
          if (!empty($message_error)) {
            ...
            <?php
              ...
              echo form_open('admin/bauexpense/dirupdate/'.$log_id, $attributes); ?>
...
<td>
  ...
  <?php if($data->file_name != 'default.jpg') { ?><a onclick="return popWindow(this);" href="<?php echo base_url('exp_files/'.$log_details['file_name']) ?>">
<?php 
...
<tr>
 <td>
  <label><strong>HOD Name :</strong></label></td>
 <td>
...
<tr>
 <td>
  <label >
       <strong>HOD Status :</strong></label>
 </td>
 <td><?php echo $taskStatus_arr[$log_details['hod_status']];   ?> 
 </td>
</tr>
<tr>
 <td><label> <strong>HOD Comment :</strong></label></td>
 <td> <?php  echo $log_details['hod_comment'];  ?> 
 </td>
</tr>

<tr>
 <td>
  <label><strong>Finacial Controller Name :</strong></label></td>
 <td>
    <?php   $proj_mana_details = $this->settingsmodel->getEmployeeDetails($log_details['account_controller_id']); 
            echo $proj_mana_details['first_name'].' '.$proj_mana_details['last_name']; ?>
 </td>
</tr>
<tr>
 ...
 <td><?php echo $taskStatus_arr[$log_details['account_controller_status']];   ?> 
 </td>
</tr>
<tr>
 <td><label> <strong>Finacial Controller Comment :</strong></label></td>
 <td> <?php  echo $log_details['account_controller_comment'];  ?> 
 </td>
</tr>
