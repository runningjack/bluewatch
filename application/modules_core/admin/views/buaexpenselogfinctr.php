...
<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">							
							<h3>BUA Expense Request Log (Finacial Controller/HR)</h3>
...
<td>
  ...
  // var_dump($_SESSION['login_detal']->group_id == 5);exit;
   ...
   if (($data->account_controller_status == null && $_SESSION['login_detal']->group_id == 7) || $data->account_controller_status == 3) {
       ?>
   <a 
      href="<?php echo base_url('admin/bauexpense/projectfinupdate/'.$data->bau_exp_id); ?>" > <button class="btn btn-warning" type="button">Approve / Assign Director</button></a>
   ...
   <?php
    ...
    if ($_SESSION['login_detal']->group_id == 7 || $data->director_status == 1) {
       ?>
   <a 
      href="<?php echo base_url('admin/bauexpense/projectfinupdate/'.$data->bau_exp_id); ?>" > <button class="btn btn-success" type="button">Paid</button></a>
