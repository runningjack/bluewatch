...
function calculateBudgetSubHeadSumModify(objectPro)
{
        $("#error_display").hide();
        ...
        let target_total_head =  $(objectPro).attr('target_total_head');
        let department_budget =  $(objectPro).attr('department_budget');
     //   department_budget
        ...
        console.log("department_budget : "+department_budget );
        ...
        var project_total_budget = $('#'+department_budget).val();
