...
<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">							
							<h3>BAU Employee Expense Request Log (Director)</h3>
            ...
            <?php
								...
								<table class="table table-bordered" id="datatable2" >
                                    ...
                                    <td colspan="8"><strong>Expense Details</strong></td>
...
<td>
  ...
  // var_dump($_SESSION['login_detal']->group_id == 5);exit;
   ...
   if ($data->account_controller_status == 1 && $_SESSION['login_detal']->group_id == 2 && $data->director_status != 1 ) {
            ?>
   <a 
      href="<?php echo base_url('admin/bauexpense/dirupdate/'.$data->bau_exp_id); ?>" > <button class="btn btn-warning" type="button">Approve / Assign Director</button></a>
