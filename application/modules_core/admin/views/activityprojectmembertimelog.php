...
<?php ++$counter;
  ...
  <script type="text/javascript">
          ...
          $(document).ready(function(){
            ...
            $.ajax({
                     url:'<?php echo base_url('admin/projectlogs/saveteamLeadReviewLogActivities'); ?>',
                     type:"POST",
                     data: fd,
                     contentType: false,
                    processData: false,
           ...
           function SumHour(obj) {
            ...
            var number = 0;
             var total = 8*7;
             var elements = document.getElementsByName("teamLeadhour[]");
        ...
        var elements1 = document.getElementsByName("otherteamLeadhour[]");
