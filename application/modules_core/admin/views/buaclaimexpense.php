...
<div class="row">
            ...
            <?php
              ...
              echo form_open('admin/bauexpense/claimexpense/', $attributes); ?>
...
<td>
<input name="amount" id="amount" step="0.01" class="form-control" type="number" min="1" value="<?=$_POST['amount']?>"  required>
