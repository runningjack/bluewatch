...
<div class="row">
            ...
            <?php } ?><?php $attributes = array( 'id' => 'usersform');
              echo form_open('admin/subunit/add/',$attributes);?>
								<table class="table table-bordered" id="datatable2" >
                                                                    <tr><td width="30%" ><strong>Unit Name:</strong></td><td > <?php echo form_dropdown('unit_id', $unitselement,'','required="" class="form-control"'); ?></td></tr>
                                                                    ...
                                                                    <tr><td></td><td><input  class="btn btn-primary"  type='submit' name='submit' value='Add Sub-Unit'></td></tr> 
