            ...
            <?}?><?php $attributes = array( 'id' => 'usersform');
              echo form_open('admin/department/add/',$attributes);?>
								<table class="table table-bordered" id="datatable2" >
                                                                    <tr><td><strong>Faculty Name:</strong></td><td> <?php echo form_dropdown('faculty_id', $progelement,'','required="" class="form-control"'); ?></td></tr>
                                                                    <tr><td><strong>Department Name:</strong></td><td><?php echo form_input($form_department); ?></td></tr>
                                                                    <tr><td></td><td><input type='submit' name='submit' value='Add Department'></td></tr> 
