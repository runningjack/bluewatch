...
<div class="row">
            ...
            <?}?><?php $attributes = array( 'id' => 'usersform');
              echo form_open('admin/payment/checkfee/',$attributes);?>
              ...
              <table class="table table-bordered">
                                      ...
                                      <tr><td><strong>Entry Year:</strong></td><td>
                                       ...
                                       <tr><td><strong>Student Type :</strong></td>
                                                                    ...
                                                                    <tr><td><strong>Nationality :</strong></td>
                                                                     ...
                                                                     <tr><td></td><td><input type='submit' class="btn btn-primary" name='submit' value='Check'></td></tr>        
                                                                            </table>
                    ...
                    <td><div >
                                                            ...
                                                            <table class="table table-bordered">
                        <?php //var_dump($amounts);exit;
                        if(!isset($amounts)){?>
                            <div class="error"><p>                            
                          No payment Set. Please use the form to check payment amount.
                                    </p>
                            </div>
                            
                       <? }else{?>
                        <tr class="head">
                        <td>S/n</td><td>Fees Items</td> <td>Amount</td>
                        <? $cnt = 1;
                        $sum = 0;
                        if(($cnt%2)<1){$style = 'even';}else{$style = 'odd';}
                        foreach($amounts as $a){
                            $sum = $sum + $a['amount'];
                      if($a['amount']>0){ echo '<tr class = "'.$style.'"><td>'.$cnt.'</td><td>'
                            .$a['fee_name'].'</td> <td>#'
                            .number_format($a['amount'],2).'</td></tr>';
                       $cnt++;
                      } 
                       }
                        echo '<td colspan="2" align="left"> Grand Total</td> <td>#'.number_format($sum,2).'</td>'; 
                        ?>
                        </tr>  
                        <?}?>
                        </table>
