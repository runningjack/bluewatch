...
<div class="row">
            ...
            <?}?><?php $attributes = array( 'id' => 'usersform');
              echo form_open('admin/maxunit/add/',$attributes);?>
                                       ...
                                       <tr><td><strong>Semester :</strong></td><td>
                                                ...
                                                <?php echo form_dropdown('semester_id', $semesterelement,'','required="" class="form-control" id="semester_id"'); ?></td></tr>                              
                                                                    ...
                                                                    <tr><td><strong>Maximum Unit :</strong></td>
                                                                        <td><input type="text" name="max" id = "max" required="" class="form-control"/></td></tr> 
                                                                    
                                                                          <tr><td><strong>Minimum Unit :</strong></td>
                                                                        <td><input type="text" name="min" id="min" required="" class="form-control"/></td></tr> 
                                              <tr><td></td><td><input type='submit' name='submit'  class="btn btn-facebook" value='Add Minimum'></td></tr> 
