...
<div class="row">
            ...
            <?}?>
              ...
              echo form_open('admin/transaction/verify',$attributes);?>
...
<?php         echo form_close();
         //var_dump($trans_details["status"]);//exit;
                    if(isset($trans_details['trans_total_amount'])){ 
                     ...
                     <table>
                         ...
                         <tr><td>Total Amount Paid</td><td>  <?php  echo number_format($previous_amount,2);?></td></tr>
                          <tr><td>Amount To Pay</td><td><?php  echo number_format($trans_details["trans_total_amount"],2) ?></td></tr>
                  ...
                  <div class="input-group date datetime col-md-5 col-xs-7" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control" size="20" type="text" value="" name="payment_date" readonly="">
                    <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                      ...
                      <tr><td>Tendered Amount</td><td class="input-group">
                                 ...
                                 <input type="number" name="tendered_amount"  id="tendered_amount"/>
                             <span class="input-group-addon">.00</span>
                             </td></tr>-->
                        <?php if($trans_details["status"]=='Full Payment'){ 
                           echo '<tr><td colspan="4"><span style="color:blue;" >This Transaction has Been Fully Paid for</span></td></tr>';
                             }
                       else { ?>
                         <tr>
                            <td colspan="2">
                                 <input type="submit"  style=" float: right;" class="btn btn-danger" name="reject" id="reject" value="Reject Ticket"/>
                             
                                <input type="submit" style=" float: right;" class="btn btn-primary" name="approve" id="approve" value="Approve Ticket"/></td></tr>
                       <?php }?>
                     </table>
